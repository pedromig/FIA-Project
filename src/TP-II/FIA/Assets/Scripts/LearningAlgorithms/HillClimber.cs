...
public class HillClimber : MetaHeuristic
{
    ...
    public override void InitPopulation()
    {
        ...
        {
            HillClimberIndividual new_ind_red = new HillClimberIndividual(NNTopology, GamesPerIndividualForEvaluation, mutationMethod, CrossoverType.None, FitnessType.None);
            HillClimberIndividual new_ind_blue = new HillClimberIndividual(NNTopology, GamesPerIndividualForEvaluation, mutationMethod, CrossoverType.None, FitnessType.None);
